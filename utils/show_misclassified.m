...
pedpaths = dir_filenames(sprintf('data/%s/test/pedestrians', current_set), '\.jpg', true);
nonpaths = dir_filenames(sprintf('data/%s/test/nonpedestrians', current_set), '\.jpg', true);
