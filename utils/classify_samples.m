...
print(sprintf('data/%s/charts/k=%d/roc_total.pdf', current_set, k), '-dpdf');
close;
...
print(sprintf('data/%s/charts/k=%d/roc_grayscale.pdf', current_set, k), '-dpdf');
close;
...
print(sprintf('data/%s/charts/k=%d/roc_edge.pdf', current_set, k), '-dpdf');
close;
...
print(sprintf('data/%s/charts/k=%d/roc_positive.pdf', current_set, k), '-dpdf');
close;
...
print(sprintf('data/%s/charts/k=%d/roc_negative.pdf', current_set, k), '-dpdf');
close;
...
print(sprintf('data/%s/charts/k=%d/roc_total_weighted.pdf', current_set, k), '-dpdf');
close;
